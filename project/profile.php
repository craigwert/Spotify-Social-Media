...
<ul>
  ...
  <li><a href="#">Artist 7</a></li>
  <li><a href="#">Artist 8</a></li>
</ul> -->
			...
			<?php
				...
				$query = "SELECT authToken FROM spotifyDB";
			...
			?>
<script>
				var accessToken = <?php echo $authToken?>;			

			function getUserData(accessToken) {
                                return $.ajax({
				url: 'https://api.spotify.com/v1/search?q=name:(namehere)&type=(album, artist)&limit=1',
                                headers: {
                        ...
                        getUserData(accessToken).done(function(json){
...
<iframe src="https://open.spotify.com/embed/album/1To7kv722A8SpZF789MZy7" width="238" height="272" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
<div class="sections">
<div class="section1">
<h3>Maybe put album artwork here?</h3>
<p>&nbsp;</p>
